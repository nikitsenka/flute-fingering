...
window.I18N_STRINGS.ja = {
  ...
  "import.pdf.timed": "音の長さは符幹・符尾・連桁から読み取りました。二分音符と四分音符は区別できず、足りない小節は休符で補っています。リズムは近いだけで正確ではありません。",
  "import.pdf.accidentals": "音符の横の臨時記号は読み取っていないため、変化音はそのままの音として入ります。",
  "import.pdf.altered": "臨時記号を {n} 個読み取りました。小節の残りには及ばないため、同じ音が再び出るときは記号なしで入ります。",
  "import.pdf.staves": "{n} 段を上から順に 1 つの譜として読み取りました。",
  "import.pdf.bass": "別の音部記号の譜（ピアノの左手）にある音符 {n} 個は除きました。",
  "import.pdf.scanned": "ページの画像から読み取りました。十音に一音ほど欠けることがあり、リズムは印刷された音価ではなくインクの形から読んだものです。練習の前に楽譜と照らし合わせてください。",
  "import.pdf.metre": "拍子記号は読み取っていません。1 小節は 4 拍として扱います。3/4 や、揺れるバラードの 12/8 など別の拍子で書かれた曲では、音が正しくても小節線の位置がずれます。",
